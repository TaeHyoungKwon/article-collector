...
## TL;DR
- 이 글은 Rocky라는 SQL 변환 엔진의 기능과 특징을 다루고 있다.
- Rocky는 스키마 드리프트 감지, 컴파일 타임 데이터 계약 등 다양한 자동화 기능을 제공하여 데이터 파이프라인의 안정성을 높인다.
- 독자는 이를 통해 데이터 품질을 유지하고 운영환경에서의 문제를 사전에 예방할 수 있는 방법을 알 수 있다.
