...
## TL;DR
- 이 글은 AI 에이전트들이 프로젝트 기억을 공유하는 오픈소스 툴 'memorize'의 개발과 그 필요성을 다룬다.
- 프로젝트의 기억을 로컬 우선 형태로 구축하여 여러 머신 간의 협업을 가능하게 하며, 데이터의 유실을 방지하는 기능이 특징이다.
- 벤더 중립적인 대안으로 AI 협업 인프라를 제공함으로써, 에이전트 간의 효과적인 상호작용을 촉진할 수 있는 잠재적인 기회를 의미한다.
