...
## TL;DR
- 이 글은 록스타 개발자와 AI의 코드 생성이 소프트웨어 유지보수에 미치는 영향을 다룬다.
- LLM 에이전트는 수많은 코드를 빠르게 생성하지만, 시스템의 복잡도를 증가시켜 유지보수를 어렵게 만든다.
- 따라서 장기적인 소프트웨어 발전을 위해 인간의 설계를 강조하고 LLM 사용을 제한해야 한다는 점이 중요하다.
