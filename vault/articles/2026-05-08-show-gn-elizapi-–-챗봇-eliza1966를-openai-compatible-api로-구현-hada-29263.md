...
## TL;DR
- 이 글은 챗봇 Eliza를 OpenAI 호환 API로 구현한 ElizAPI 프로젝트에 대해 다루고 있다.
- ElizAPI는 역사적 챗봇인 Eliza의 대화 방식을 현대 기술로 재구성하여 비용 효과적인 서비스를 제공한다.
- 이 프로젝트는 LLM에 의존하지 않는 챗봇의 가능성을 제시하며, 기술의 실제 활용에 대한 새로운 시각을 제공한다.
