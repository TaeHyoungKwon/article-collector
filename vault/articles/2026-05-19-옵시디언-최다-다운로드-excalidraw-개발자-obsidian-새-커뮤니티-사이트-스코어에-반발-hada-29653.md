---
category: AI
collected_at: '2026-05-19T11:40:22+09:00'
geeknews_comments: 0
geeknews_score: 5
geeknews_url: https://news.hada.io/topic?id=29653
id: hada-29653
matched_keywords:
- AI
read: false
...
- "공급망 공격이 일상인 시대에 사용자 책임론은 다소 안일하다" (mesarthim\_2, 112 likes)
- "객관적 측정을 개인 공격으로 받아들였다. 점수가 마음에 안 들면 점수를 고치는 게 정답" (DeliriumTrigger)
- "오픈소스 커뮤니티 자체가 '무료가 당연하다'는 인식에 일조했다. 좋은 소프트웨어로 부자가 되는 게 부끄러울 일이 아니다" (mesarthim\_2)
- "구독은 피로하다. 일회성 라이선스 + 자체 호스팅 Sync 패키지가 더 끌린다" (rg\_software)
- "AI가 플러그인 개발 진입장벽을 낮춘 만큼 보안 감사는 필수" (Legal\_1425)
...
- 💬 Reddit: [https://reddit.com/r/ObsidianMD/…](https://www.reddit.com/r/ObsidianMD/comments/1tg4e3c/excalidraw_plugin_developer_the_future_of/)
- 📋 Obsidian 공식 발표: [The Future of Plugins](https://obsidian.md/blog/future-of-plugins/)

## 원문
- [원문](https://www.youtube.com/watch?v=wedHXARs6n4)
- [GeekNews 토론](https://news.hada.io/topic?id=29653)
