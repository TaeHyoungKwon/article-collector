...
brew tap baserize/full-brightness
https://github.com/baserize/full-brightness
...
Apple 내장 디스플레이처럼 macOS 기본 밝기 조절과 더 가깝게 동작하려면 공개 API만으로는 한계가 있었습니다. 그래서 직접 배포 버전에서는 private
DisplayServices
경로를 사용합니다.
