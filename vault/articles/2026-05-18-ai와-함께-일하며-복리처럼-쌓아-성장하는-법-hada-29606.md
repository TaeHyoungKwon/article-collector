...
## TL;DR
- 이 글은 AI와의 협업을 통해 성과를 누적하며 성장하는 방법을 다룬다.
- 컨텍스트 제공과 피드백 루프 등 다섯 가지 원칙을 기반으로 작업 성과가 누적되는 복리 구조를 설명한다.
- 이러한 원칙은 AI 뿐 아니라 인간 팀 간의 협업에도 유용하여 효율성을 높일 수 있다.
