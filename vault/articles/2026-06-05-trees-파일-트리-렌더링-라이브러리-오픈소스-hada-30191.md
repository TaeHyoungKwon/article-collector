...
## TL;DR
- Trees는 VSCode의 파일/디렉터리 구조를 렌더링하는 오픈소스 라이브러리이다.
- 이 라이브러리는 자동 가상화 기능을 통해 수만 개 항목도 신속하게 렌더링하며, 다양한 개발 도구형 UI 기능을 지원한다.
- 접근성과 커스터마이징이 용이하여 에디터나 코드 호스팅 도구에서 유용하게 활용될 수 있다.
