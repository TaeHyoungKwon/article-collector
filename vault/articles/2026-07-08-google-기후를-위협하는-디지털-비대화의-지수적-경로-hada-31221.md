...
## TL;DR
- 이 글은 Google의 기후 보고서에서 디지털 비대화가 전력 소비와 기후에 미치는 영향을 다룬다.
- 생성형 AI 확장으로 인해 Google의 전력 소비가 2024년 31TWh에서 2025년 43TWh로 증가하며 지수적 성장 양상을 보인다.
- AI 인프라의 에너지 수요 증가는 기후 변화에 대한 우려를 더욱 증대시키며, 기업의 지속 가능성에 대한 질문을 제기한다.
