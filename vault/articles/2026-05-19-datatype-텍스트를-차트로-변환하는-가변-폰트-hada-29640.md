---
category: Other
collected_at: '2026-05-19T09:31:02+09:00'
geeknews_comments: 13
geeknews_score: 33
geeknews_url: https://news.hada.io/topic?id=29640
id: hada-29640
matched_keywords: []
read: false
recommend_score: -995.682
recommended_on: '2026-05-19'
source: geeknews
tags:
- Other
- github.com/franktisellano
title: Datatype - 텍스트를 차트로 변환하는 가변 폰트
url: https://github.com/franktisellano/datatype
---

## TL;DR
- 이 글은 텍스트 데이터를 차트로 변환하는 가변 폰트인 Datatype에 대해 다룬다.
- Datatype은 OpenType 합자 치환을 이용해 텍스트를 직접 인라인 차트로 렌더링할 수 있는 기능을 제공한다.
- 이 기술은 복잡한 그래픽 없이 텍스트 환경에서도 데이터 시각화를 가능하게 하여 다양한 플랫폼에서 쉽게 활용될 수 있다.
...
## 원문
- [원문](https://github.com/franktisellano/datatype)
- [GeekNews 토론](https://news.hada.io/topic?id=29640)
