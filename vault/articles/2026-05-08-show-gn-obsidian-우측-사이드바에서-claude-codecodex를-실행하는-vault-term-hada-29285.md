...
## TL;DR
- 이 글은 Obsidian에서 Claude Code, Codex를 실행하기 위한 Vault Terminal 플러그인을 소개한다.
- 사용자는 Obsidian 우측 사이드바에서 터미널을 실행하고 다양한 CLI 도구를 효율적으로 사용할 수 있다.
- 이 플러그인은 Obsidian 사용자들에게 프로그래밍 작업을 통합적으로 수행할 수 있는 환경을 제공하여 생산성을 높일 수 있다.
